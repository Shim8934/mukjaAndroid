...
public class EroomAdapter extends BaseAdapter {
    ...
    private CustomActivity customDialog;
 ...
 */
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Log.i("", "http://115.91.88.230:9998/mukja" + items.get(position).getU_img());
        itemIcon.setImageURI(Uri.parse("http://115.91.88.230:9998/mukja" + items.get(position).getU_img()));
        //텍스트뷰 위젯 얻고 데이터 설정]
